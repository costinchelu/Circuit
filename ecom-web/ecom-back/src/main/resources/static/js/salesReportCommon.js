...
function validateDateRange(reportType, callbackFunction) {
    ...
    if (days >= 7 && days <= 30) {
        ...
        startDateField.setCustomValidity("Data trebuie să fie în intervalul 7..30 zile");
...
function getChartTitle(period) {
    if (period === "last_7_days") return "Vânzări în ultimele 7 zile";
    if (period === "last_28_days") return "Vânzări în ultimele 28 zile";
    if (period === "last_6_months") return "Vânzări în ultimele 6 luni";
    if (period === "last_year") return "Vânzări în ultimul an";
    if (period === "custom") return "Vânzări în interval";
