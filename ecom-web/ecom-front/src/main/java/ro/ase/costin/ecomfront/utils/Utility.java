...
import ro.ase.costin.ecomfront.security.oauth.CustomerOAuth2User;
...
public class Utility {
    ...
    public static String formatCurrency(float amount, CurrencySettingBag settings) {
        ...
        if (symbolPosition.equals("Before price")) {
            pattern.append(symbol).append(" ");
        }
        ...
        if (symbolPosition.equals("After price")) {
            pattern.append(" ").append(symbol);
        }

        char decimalSeparator = decimalPointType.equals("POINT") ? '.' : ',';
        char thousandSeparator = Character.MIN_VALUE;
        switch (thousandPointType) {
            case "POINT":  thousandSeparator = '.'; break;
            case "COMMA": thousandSeparator = ','; break;
            case "WHITESPACE": thousandSeparator = ' '; break;
            default: break;
        }
